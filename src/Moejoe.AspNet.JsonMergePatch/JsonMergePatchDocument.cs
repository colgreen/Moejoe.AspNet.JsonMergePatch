...
namespace Moejoe.AspNet.JsonMergePatch
{
    ...
    public class JsonMergePatchDocument<TResource> : IJsonMergePatchDocument<TResource>, IValidatableObject
        where TResource : class
    {
        ...
        public JsonMergePatchDocument(string patchDocument, JsonSerializerSettings settings = null)
        {
            ...
            try
            {
                ...
                _internalDocument = new PatchDocument(
                    patchObject, typeof(TResource), serializer);
            }
        ...
        {
            return _internalValidator.Validate(
                validationContext,
                _internalDocument.Patch,
                _serializerSettings ?? JsonConvert.DefaultSettings?.Invoke());
        }
    }
}